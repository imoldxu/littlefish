...
import com.x.data.vo.GroupTourVo;
...
public class GroupTourController {
	...
	public MongoPageResult<GroupTourItemVo> query(
			@ApiParam(name = "groupTourQuery", value = "日期查询条件") @Valid GroupTourQuery groupTourQuery,
			HttpServletRequest request, HttpServletResponse response) {
	
		MongoPageResult<GroupTourItemVo> result = groupTourService.query(groupTourQuery);
		return result;
	}
