...
public class ErrorCode {
	...
	public static final int BALANCE_NOT_ENOUGH = 155;
	...
	public static final int ALI_PAY_ERROR = 315;
	public static final int SF_ERROR = 321;
	public static final int OTHERPAY = 391; //其他渠道已支付，或相同渠道的第二笔支付
