import { getUserTrend } from '@/services/user';
...
const UserTrendLine = (props)=>{
    ...
    const refresh = async(type)=>{
        ...
        try{
            const result = await getUserTrend({timeDimension: type,
    ...
    return (
        <Card title="新增用户趋势" extra={<Radio.Group options={timeDimensionOption} 
