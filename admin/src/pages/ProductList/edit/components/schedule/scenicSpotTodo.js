    ...
    return (
        <Card title="景点">
            <Row align="middle" gutter={[16, 16]}>
                ...
                <Col>
                    <Space><span>景点名称：</span>
                        <Input placeholder="请输入景点名称" 
                            onBlur={e =>
                                handleChange({ scenicSpotName: e.target.value })
                            }
                            defaultValue={value.scenicSpotName}>    
                        </Input>
                    </Space>
                </Col>
                <Col>
